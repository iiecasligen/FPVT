...
def get_flow(fake_frame_root, source_frame_root, fake_mask_root, source_mask_root,
             fake_flow_root, source_flow_root, model_path, use_gpu_id, parser_argument):
    ...
    print("# step6: get scene frame flow")
...
if __name__ == '__main__':
    ...
    arg('--small', action='store_true', help='use small model')
    arg('--mixed_precision', action='store_true', help='use mixed precision')
    arg('--alternate_corr', action='store_true', help='use efficient correlation implementation')
