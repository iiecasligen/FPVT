...
def prepare_input_video(video_path, frame_root, rect_root, mask_root, back_root, fore_root):
    print("# step3: get fake video, all frames, back, mask, fore and rect info")
    ...
    video_cap.release()
    print("# step3: get {} frames over".format(frame_num))
    ...
    print("# step3: get back, mask and fore in process over")
    ...
    print("# step3 Successful: get one rect pkl file over")
