...
def flow_map(fake_flow_root, source_flow_root, use_gpu_id, model_path,
    ...
    frame_index_begin = int(input("# step7: input sample frame number begin (include) (= flow begin num): "))
    frame_index_end = int(input("# step7: input sample frame number end (not include) (= flow end num + 1): "))
    flow_index_begin = frame_index_begin
    flow_index_end = frame_index_end - 1
    choose_num = int(input("# step7: choose num of map flow: "))
    ...
    print("# step7: fake flow range: [{}, {}]".format(flow_index_begin, flow_index_end))
    print("# step7: fake frame range: [{}, {}]".format(frame_index_begin, frame_index_end))
