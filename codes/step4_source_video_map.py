...
def source_map(fake_back_root, source_back_root, source_video_root, fake_video_path,
    ...
    print("# step4: get source video by scence map")
    ...
    choose_num = int(input("# step4: choose num of map scence: "))
    ...
    print("# step4: fake image width: {}".format(image_width))
    print("# step4: fake image height: {}".format(image_height))
    sample_cut = int(input("# step4: input sample cut size: "))
    test_data = ReturnTestImageCouple2(fake_back_root=fake_back_root, source_back_root=source_back_root,
                                       test_pairs=test_pairs, image_width=image_width, image_height=image_height,
                                       sample_cut=sample_cut, image_size=image_size)
...
if __name__ == '__main__':
    ...
    arg('--recompute_num', type=int, default=5, help="")
